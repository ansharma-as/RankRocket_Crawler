          ...
          >
            ...
            <div className="mt-6">
              <button
                type="button"
                disabled
                className="w-full inline-flex justify-center py-3 px-4 border border-neutral-600 rounded-lg bg-neutral-800/50 backdrop-blur-md text-sm font-medium text-gray-400 hover:bg-neutral-700/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
